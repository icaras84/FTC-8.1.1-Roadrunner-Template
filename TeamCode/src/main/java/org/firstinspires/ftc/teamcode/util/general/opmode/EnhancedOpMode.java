package org.firstinspires.ftc.teamcode.util.general.opmode;
...
public abstract class EnhancedOpMode extends OpMode {
    ...
    protected DSController driver1, driver2;
    ...
    public MultipleTelemetry getMultiTelemetry(){
        return new MultipleTelemetry(getTelemetry(), FtcDashboard.getInstance().getTelemetry());
    }

    public DSMasterController getMasterInputController(){
